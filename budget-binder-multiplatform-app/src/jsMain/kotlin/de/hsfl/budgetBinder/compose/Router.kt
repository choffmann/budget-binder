...
fun Router() {
    ...
    when (screenState.value) {
        ...
        is Screen.Settings, is Screen.SettingsChangeUserData -> Text("Settings")//SettingsComponent(screenState = screenState)
        is Screen.CategorySummary, is Screen.CategoryEdit, is Screen.CategoryCreate, is Screen.CategoryCreateOnRegister ->Text("Old Category") //CategoryComponent(screenState = screenState)
        ...
        else -> {Text("No known Screen! Check if the screen you're trying to reach is in the ScreenRouter")}
    }
}
